...
public class TransactionDisplayFormatterTest {
    ...
    @Test public void titleUsesExactSmsSenderAndOnlyMarksPresentAddresses() {
        assertEquals("MVola ✅", TransactionDisplayFormatter.senderTitle("MVola"));
        assertEquals("+261341234567 ✅",
                TransactionDisplayFormatter.senderTitle("+261341234567"));
        assertEquals(" Expéditeur brut  ✅",
                TransactionDisplayFormatter.senderTitle(" Expéditeur brut "));
        assertEquals("Expéditeur inconnu", TransactionDisplayFormatter.senderTitle(null));
        assertEquals("Expéditeur inconnu", TransactionDisplayFormatter.senderTitle("  "));
        assertEquals("Expéditeur inconnu ✅",
                TransactionDisplayFormatter.senderTitle("Expéditeur inconnu"));
    }
}
