...
public class SmsReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            com.netk.mvolatrack.database.SmsMessage localMessage =
                    com.netk.mvolatrack.database.SmsMessage.create(
                    ...
                    if (error == null) {
                        if (rowId == -1L) {
                            ...
                            if (parsedTransaction != null) {
                                com.netk.mvolatrack.overlay.TransactionOverlayCoordinator
                                        .get(appContext).onTransactionReceived(
                                                rowId, sender, parsedTransaction);
                            }
                        }
                    } else {
